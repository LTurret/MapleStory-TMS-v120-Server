...
public class NPCScriptManager extends AbstractScriptManager {
    ...
    public final void dispose(final MapleClient c) {
        ...
        if (npccm != null) {
            cms.remove(c);
            if (npccm.getType() == -1) {
                c.removeScriptEngine("lib/scripts/npc/" + npccm.getNpc() + ".js");
                c.removeScriptEngine("lib/scripts/npc/notcoded.js");
            } else {
                c.removeScriptEngine("lib/scripts/quest/" + npccm.getQuest() + ".js");
            }
        }
